    ...
    <div className="relative min-h-screen bg-slate-950 overflow-hidden selection:bg-primary/30 selection:text-white">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <div className="flex min-h-0 flex-1 flex-col items-center px-4">
          <div className="flex-[0.68] flex flex-col justify-end pt-0 md:flex-[0.88] md:pt-0">
            ...
            >
              <motion.h1
                ...
                className="mb-3 select-none font-serif text-[4.75rem] font-bold leading-[0.84] tracking-tighter text-white sm:text-[6.5rem] md:mb-5 md:text-[14rem]"
              >
                Scribe
              </motion.h1>
            </motion.div>
          ...
          >
            <div className="w-full text-left text-[9px] font-bold uppercase tracking-[0.24em] text-slate-600 md:text-[10px] md:tracking-[0.4em]">
              © 2026 Aidan Alcayde
            </div>
